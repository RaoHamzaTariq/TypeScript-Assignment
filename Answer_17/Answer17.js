...
/// Answer:
// Program 16:
var guest_names = ['Hamza', 'Sohail', 'Rohail', 'Taha', 'Hammad'];
...
while (guest_names.length > 2) {
    var removed_guest = guest_names.pop();
    console.log("I am sorry to ".concat(removed_guest, " for not inviting them to dinner"));
}
for (var i = 0; i < guest_names.length; i++) {
    console.log("".concat(guest_names[i], " are inviting to the dinner in my home"));
}
